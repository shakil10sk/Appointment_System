            ...
            <div class="container-fluid">
                <div class="header-menu-content">
                    <nav class="navbar navbar-expand-lg p-0" >
                        <a class="site-logo site-title" href="{{url('/')}}"><img src="{{ asset('assets/images/logo.png') }}" alt="site-logo"></a>
                        ...
                        @else
                        <div class="dropdown">
                            <button class="btn btn-secondary dropdown-toggle cmn-btn" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                {{ Auth::user()->name }}
                            </button>
